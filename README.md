...
[demo]: https://next-ts-auth-trpc-prisma.d1a.app/
[license]: https://github.com/doinel1a/next-ts-auth-trpc-prisma/blob/main/LICENSE
[code-of-conduct]: https://github.com/doinel1a/next-ts-auth-trpc-prisma/blob/main/CODE_OF_CONDUCT.md
[issues]: https://github.com/doinel1a/next-ts-auth-trpc-prisma/issues
[pulls]: https://github.com/doinel1a/next-ts-auth-trpc-prisma/pulls
...
This repository is ideal for full-stack developers who want to build modern, fast and reliable web applications with the latest cutting edge technologies such as **Next.js 15**, **React.js 19**, **Auth.js**, **TRPC**, **Prisma**, **TypeScript**, **Shadcn/ui**, **TailwindCSS 4**, **ESLint**, **Prettier**, **Husky** and much more!
...
- Get the repository:
  ...
  - **clone** the repository through your terminal: <br />
    ```bash
    git clone https://github.com/doinel1a/next-ts-auth-trpc-prisma YOUR-PROJECT-NAME
    ```
